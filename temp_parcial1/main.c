...
void tim_setup(void){
    ...
    gpio_primary_remap(
                       ...
                       AFIO_MAPR_TIM3_REMAP_NO_REMAP);        // This is default: TIM3.CH3=GPIOB1
    ...
    timer_set_mode(TIM3,
                   ...
                   TIM_CR1_CMS_EDGE,
                   TIM_CR1_DIR_UP);
    timer_set_prescaler(TIM3,800); //see https://github.com/ve3wwg/stm32f103c8t6/pull/12/
    // Only needed for advanced timers:
    // timer_set_repetition_counter(TIM3,0);
    timer_enable_preload(TIM3);
    timer_continuous_mode(TIM3);
    timer_set_period(TIM3,time_cycle);
